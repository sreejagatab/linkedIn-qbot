...
class WatiAPIClient:
    ...
    def create_custom_webhook(self, webhook_url: str, events: List[str]) -> Dict[str, Any]:
        ...
        Note: According to the Wati API documentation, webhooks should be set up through the Wati dashboard,
        not through an API endpoint. This method is kept for compatibility but will return a message
        instructing the user to set up the webhook through the dashboard.
        ...
        """
        logger.info(f"Webhook setup requested for URL: {webhook_url}")
        logger.info("According to Wati API documentation, webhooks should be set up through the Wati dashboard.")
        logger.info("Please visit https://app.wati.io/ and go to Webhooks section to set up your webhook.")

        return {
            "message": "Webhook setup should be done through the Wati dashboard.",
            "webhook_url": webhook_url,
            "events": events,
            "instructions": "Please visit https://app.wati.io/ and go to Webhooks section to set up your webhook."
        }
    ...
    def delete_webhook(self) -> Dict[str, Any]:
        ...
        Note: According to the Wati API documentation, webhooks should be managed through the Wati dashboard,
        not through an API endpoint. This method is kept for compatibility but will return a message
        instructing the user to manage webhooks through the dashboard.

        Returns:
            Response with instructions
        """
        logger.info("Webhook deletion requested.")
        logger.info("According to Wati API documentation, webhooks should be managed through the Wati dashboard.")
        logger.info("Please visit https://app.wati.io/ and go to Webhooks section to delete your webhook.")

        return {
            "message": "Webhook deletion should be done through the Wati dashboard.",
            "instructions": "Please visit https://app.wati.io/ and go to Webhooks section to delete your webhook."
        }
